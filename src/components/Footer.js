...
class Footer extends React.Component {
	render() {
		return (
			<FooterContainer>
				<SocialIcons>
					<IconLink style={linkStyles} href="https://twitter.com/jonathan_gallo_" target="_blank">
					...
					<IconLink style={linkStyles} href="https://www.instagram.com/_jonathan_gallo_" target="_blank">
					...
					<IconLink style={linkStyles} href="https://www.facebook.com/jonnygallo" target="_blank">
					...
					<IconLink style={linkStyles} href="https://github.com/jonnyoneiro" target="_blank">
					...
					<IconLink style={linkStyles} href="https://www.linkedin.com/in/j-gallo" target="_blank">
					...
					{/* <Link href="https://www.medium.com/@jonathangallo" target="_blank"><img className="socialIcon" src="images/icons/medium-logo.svg" alt="Medium" /></a> */}
				</SocialIcons>
				<Copyright style={this.props.backgroundIsBlack ? {color:'white'} : {color:'black'}}>&copy; Jonathan Gallo - 2018</Copyright>
			</FooterContainer>
		);
	}
}
