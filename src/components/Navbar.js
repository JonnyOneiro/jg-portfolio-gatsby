...
class Navbar extends React.Component {
	render() {
		return (
			<Header>
				<HeaderContainer>
					<Link to="/" style={linkStyles}><HeadLogo src={require('../images/jonathan-gallo.png')} alt="logo" /></Link>
					<HeadMenu>
						<Link to="/" style={linkStyles}><MenuItem>Home</MenuItem></Link>
						<Link to="/about/" style={linkStyles}><MenuItem>About</MenuItem></Link>
            <Link to="/portfolio/" style={linkStyles}><MenuItem>Portfolio</MenuItem></Link>
...
//   query {
//     file(relativePath: { eq: "../images/jonathan-gallo.png" }) {
//       childImageSharp {
