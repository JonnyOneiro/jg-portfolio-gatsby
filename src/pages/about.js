...
class About extends React.Component {
	render() {
        ...
        <Layout
          pageTitle="About Me - "
          headline="Who is Jonathan Gallo?"
          className="aboutPage"
        ...
        >
					<Body>
						<AboutSection>
							...
							<AboutContent>
                My name is Jonathan Gallo. I am a front-end web developer. I love to code websites and stuff like that.<br />
                I started learning to code HTML and CSS in 2018 after I graduated high school. I was a little on-and-off with my learning up until the end of 2017 where I decided that web development was, indeed, the career I wanted to pursue. From there, I jumped into JavaScript and have been falling more and more in love with web development ever since.
							</AboutContent>
							<AboutContent>
